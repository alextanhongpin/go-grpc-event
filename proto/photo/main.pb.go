...
func (*Photo) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{0} }
...
func (*GetPhotosRequest) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{1} }
...
func (*GetPhotosResponse) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{2} }
...
func (*GetPhotoRequest) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{3} }
...
func (*GetPhotoResponse) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{4} }
...
func (*CreatePhotoRequest) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{5} }
...
func (*CreatePhotoResponse) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{6} }
...
func (*UpdatePhotoRequest) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{7} }
...
func (*UpdatePhotoResponse) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{8} }
...
func (*DeletePhotoRequest) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{9} }
...
func (*DeletePhotoResponse) Descriptor() ([]byte, []int) { return fileDescriptorMain, []int{10} }
...
func (m *Photo) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Src) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintMain(dAtA, i, uint64(len(m.Src)))
		i += copy(dAtA[i:], m.Src)
	}
	if len(m.Caption) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintMain(dAtA, i, uint64(len(m.Caption)))
...
func (m *GetPhotosRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Page != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintMain(dAtA, i, uint64(m.Page))
	}
	if m.PerPage != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintMain(dAtA, i, uint64(m.PerPage))
	}
	return i, nil
}
...
func (m *GetPhotosResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TotalCount != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintMain(dAtA, i, uint64(m.TotalCount))
	}
	if len(m.Next) > 0 {
		dAtA[i] = 0x1a
		i++
		i = encodeVarintMain(dAtA, i, uint64(len(m.Next)))
		i += copy(dAtA[i:], m.Next)
	}
	if len(m.Last) > 0 {
		dAtA[i] = 0x22
		i++
		i = encodeVarintMain(dAtA, i, uint64(len(m.Last)))
		i += copy(dAtA[i:], m.Last)
	}
	if len(m.First) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintMain(dAtA, i, uint64(len(m.First)))
		i += copy(dAtA[i:], m.First)
	}
	if len(m.Prev) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintMain(dAtA, i, uint64(len(m.Prev)))
...
func (m *GetPhotosRequest) Size() (n int) {
	...
	if m.Page != 0 {
		n += 1 + sovMain(uint64(m.Page))
	}
	if m.PerPage != 0 {
		n += 1 + sovMain(uint64(m.PerPage))
	}
	return n
}
...
func (m *GetPhotosResponse) Size() (n int) {
	...
	if m.TotalCount != 0 {
		n += 1 + sovMain(uint64(m.TotalCount))
	}
	l = len(m.Next)
	if l > 0 {
		n += 1 + l + sovMain(uint64(l))
...
func init() { proto.RegisterFile("proto/photo/main.proto", fileDescriptorMain) }
...
var fileDescriptorMain = []byte{
	...
	,
}
